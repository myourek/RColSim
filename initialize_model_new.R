...
reservoir_vol_df$MICAA[1] <- reservoir_vol_df$MICAA[1] + (dams_in$MICAA[1] - dams_out$MICAA[1])
reservoir_vol_df$ARROW[1] <- reservoir_vol_df$ARROW[1] + (dams_in$ARROW[1] - dams_out$ARROW[1]) 
reservoir_vol_df$DUNCA[1] <- reservoir_vol_df$DUNCA[1] + (dams_in$DUNCA[1] - dams_out$DUNCA[1]) 
reservoir_vol_df$CORRA[1] <- reservoir_vol_df$CORRA[1] + (dams_in$CORRA[1] - dams_out$CORRA[1]) 
reservoir_vol_df$LIBBY[1] <- reservoir_vol_df$LIBBY[1] + (dams_in$LIBBY[1] - dams_out$LIBBY[1]) 
reservoir_vol_df$FLASF[1] <- reservoir_vol_df$FLASF[1] + (dams_in$FLASF[1] - dams_out$FLASF[1]) 
reservoir_vol_df$GCOUL[1] <- reservoir_vol_df$GCOUL[1] + (dams_in$GCOUL[1] - dams_out$GCOUL[1])
reservoir_vol_df$DWORS[1] <- reservoir_vol_df$DWORS[1] + (dams_in$DWORS[1] - dams_out$DWORS[1]) 
reservoir_vol_df$BROWN[1] <- reservoir_vol_df$BROWN[1] + (dams_in$BROWN[1] - dams_out$BROWN[1]) 
reservoir_vol_df$FLAPO[1] <- reservoir_vol_df$FLAPO[1] + (dams_in$FLAPO[1] - dams_out$FLAPO[1]) 
reservoir_vol_df$ALBEN[1] <- reservoir_vol_df$ALBEN[1] + (dams_in$ALBEN[1] - dams_out$ALBEN[1]) 
reservoir_vol_df$CHELA[1] <- reservoir_vol_df$CHELA[1] + (dams_in$CHELA[1] - dams_out$CHELA[1]) 
reservoir_vol_df$JLAKE[1] <- reservoir_vol_df$JLAKE[1] + (dams_in$JLAKE[1] - dams_out$JLAKE[1]) 
reservoir_vol_df$PALIS[1] <- reservoir_vol_df$PALIS[1] + (dams_in$PALIS[1] - dams_out$PALIS[1]) 
reservoir_vol_df$IPARK[1] <- reservoir_vol_df$IPARK[1] + (dams_in$IPARK[1] - dams_out$IPARK[1]) 
reservoir_vol_df$RIRDM[1] <- reservoir_vol_df$RIRDM[1] + (dams_in$RIRDM[1] - dams_out$RIRDM[1]) 
reservoir_vol_df$AMERI[1] <- reservoir_vol_df$AMERI[1] + (dams_in$AMERI[1] - dams_out$AMERI[1]) 
reservoir_vol_df$MINAD[1] <- reservoir_vol_df$MINAD[1] + (dams_in$MINAD[1] - dams_out$MINAD[1]) 
reservoir_vol_df$BOISE[1] <- reservoir_vol_df$BOISE[1] + (dams_in$BOISE[1] - dams_out$BOISE[1]) 
reservoir_vol_df$PAYHS[1] <- reservoir_vol_df$PAYHS[1] + (dams_in$PAYHS[1] - dams_out$PAYHS[1]) 
reservoir_vol_df$OWYHE[1] <- reservoir_vol_df$OWYHE[1] + (dams_in$OWYHE[1] - dams_out$OWYHE[1]) 
reservoir_vol_df$PELTO[1] <- reservoir_vol_df$PELTO[1] + (dams_in$PELTO[1] - dams_out$PELTO[1]) 
