...
list_scenarios = c("Historical_baseline")
...
for(i_scr in 1:length(list_scenarios)) {
	...
	for (ii_stn in 1:length(stn_list)){
		flow_raw_month = read.table(paste("~/Routing/Output/GCAM/", scr_name, "/", stn_list[ii_stn], ".month", sep=""), header=F)
		...
		flow_raw_day = read.table(paste("~/Routing/Output/GCAM/", scr_name, "/", stn_list[ii_stn], ".day", sep=""), header=F)
	...
	write.table(daily_supply, file=paste("flow_weekly_bc/bias_corrected_GCAM/daily/", sub("/", "_", scr_name), ".txt" , sep=""), row.names=F, col.names=F) 
	
	if (scr_name == "Historical_baseline") {
		daily_demand = read.table(paste("~/Step_3/Aggregate_demand_ColSim/output/GCAM/Historical/baseline_demands.txt", sep=""))
		daily_interruptible_demand = read.table(paste("~/Step_3/Aggregate_demand_ColSim/output/GCAM/Historical/baseline_interruptible_demands.txt", sep=""))
	} else {
		daily_demand = read.table(paste("~/Step_3/Aggregate_demand_ColSim/output/GCAM/", scr_name, "_demands.txt", sep=""))
		daily_interruptible_demand = read.table(paste("~/Step_3/Aggregate_demand_ColSim/output/GCAM/", scr_name, "_interruptible_demands.txt", sep=""))
	}
...
#		write.table(time_table, "flow_weekly_bc/ts_historical.txt")
	...
	write.table(final_weekly_supply[start_index:end_index,], file=paste("flow_weekly_bc/bias_corrected_GCAM/weekly/", sub("/", "_", scr_name), ".txt", sep=""), row.names=F, col.names=F) #2nd paper-future
	...
	if (!dir.exists(paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/", strsplit(scr_name, "/")[[1]][1], sep=""))) {
		dir.create(paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/", strsplit(scr_name, "/")[[1]][1], sep=""))
	}
	
	if (scr_name == "Historical_baseline") {
		write.table(demand, paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/Historical_baseline/demand_baseline.txt", sep=""), row.names=F)
		write.table(supply, paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/Historical_baseline/supply_baseline.txt", sep=""), row.names=F)
		write.table(shortfall, paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/Historical_baseline/shortfall_baseline.txt", sep=""), row.names=F)
		write.table(iflow, paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/Historical_baseline/iflow_baseline.txt", sep=""), row.names=F)
		write.table(curtailment, paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/Historical_baseline/curtailment_baseline.txt",  sep=""), row.names=F)
		write.table(interruptible, paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/Historical_baseline/interruptible_baseline.txt",  sep=""), row.names=F)
	} else {
		write.table(demand, file=paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/", strsplit(scr_name, "/")[[1]][1], "/", "demand_", strsplit(scr_name, "/")[[1]][2],  ".txt" , sep=""), row.names=F)
		write.table(supply, file=paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/", strsplit(scr_name, "/")[[1]][1], "/", "supply_", strsplit(scr_name, "/")[[1]][2],  ".txt" , sep=""), row.names=F)
		write.table(shortfall, file=paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/", strsplit(scr_name, "/")[[1]][1], "/", "shortfall_", strsplit(scr_name, "/")[[1]][2],  ".txt" , sep=""), row.names=F)
		write.table(iflow, file=paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/", strsplit(scr_name, "/")[[1]][1], "/", "iflow_", strsplit(scr_name, "/")[[1]][2],  ".txt" , sep=""), row.names=F)
		write.table(curtailment, file=paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/", strsplit(scr_name, "/")[[1]][1], "/", "curtailment_", strsplit(scr_name, "/")[[1]][2],  ".txt" , sep=""), row.names=F)
		write.table(interruptible, file=paste("~/Step_3/Aggregate_demand_ColSim/to_step_4/GCAM/", strsplit(scr_name, "/")[[1]][1], "/", "interruptible_", strsplit(scr_name, "/")[[1]][2],  ".txt" , sep=""), row.names=F)
	}
}
