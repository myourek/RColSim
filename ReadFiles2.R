...
ModPriestRapidsFlowData_input <<- read.table("inputs/PR/ModPriestRapidsFlowData.txt", header=T)
ModCabinetFlowData_input <<- read.table("inputs/Kerr/ModCabinetFlowData.txt", header=T)
ModNoxonFlowData_input <<- read.table("inputs/Kerr/ModNoxonFlowData.txt", header=T)
ModBoundaryFlowData_input <<- read.table("inputs/AFECCandFC/ModBoundaryFlowData.txt", header=T)
ModChiefJosephFlowData_input <<- read.table("inputs/GC/ModChiefJosephFlowData.txt" , header=T)
ModRockIslandFlowData_input <<- read.table("inputs/GC/ModRockIslandFlowData.txt", header=T)
ModRockyReachFlowData_input <<- read.table("inputs/GC/ModRockyReachFlowData.txt", header=T)
ModWanapumFlowData_input <<- read.table("inputs/GC/ModWanapumFlowData.txt", header=T)
ModWellsFlowData_input <<- read.table("inputs/GC/ModWellsFlowData.txt", header=T)
ModIceHarborFlowData_input <<- read.table("inputs/DW/ModIceHarborFlowData.txt", header=T)
ModLittleGooseFlowData_input <<- read.table("inputs/DW/ModLittleGooseFlowData.txt", header=T)
ModLowerMonuFlowData_input <<- read.table("inputs/DW/ModLowerMonuFlowData.txt", header=T)
ModDallesFlowData_input <<- read.table("inputs/Dall/ModDallesFlowData.txt", header=T)
ModJohnDayFlowData_input <<- read.table("inputs/BONN/ModJohnDayFlowData.txt", header=T)
