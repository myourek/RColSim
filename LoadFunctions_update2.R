...
MIElev_ft <- function() { # Water level in dam (ft)
	...
	if (is.na(lower_el) | (lower_el == upper_el)) {
...
MIMinReq <- function() {
	...
	if (RefillMinSw() == 1) { # Default is 0
		...
		MIMinReq_o <- max(MIAvgMin, MIAssuredRelease()) * cfsTOafw
	}
	return(MIMinReq_o)
}
...
ARMinReq <- function() {
	...
	if (RefillMinSw() == 1) {
		...
		ARMinReq_o <- max(ARAvgMin, ARAssuredRelease()) * cfsTOafw
	}
	return(ARMinReq_o)
}
...
AR_April_Evac_Target <- function() {
	if (DARunoffAprAug > 80E6) {
		AR_AprilFC_o <- ARFlood_input$ARFlood6[36]
	} else if (DARunoffAprAug > 75E6) {
...
InitDULink <- 1424900
DUHistStor_input <- function() {
	DUHistStor_input_o <- HistStor_input[week_counter, 4]
	return(DUHistStor_input_o)
}
InitDU <- function() {
...
IPFloodCurve <- function() {
	if (HenryRunoffRemainingJanJun <= 0.1E6) {
		IPFloodCurve_o <- IPFlood_input$IPFlood1[week_in_year] + (HenryRunoffRemainingJanJun - 0) / (0.1E6 - 0) * (IPFlood_input$IPFlood2[week_in_year] - IPFlood_input$IPFlood1[week_in_year])
	} else if (HenryRunoffRemainingJanJun <= 0.15E6) {
		IPFloodCurve_o <- IPFlood_input$IPFlood2[week_in_year] + (HenryRunoffRemainingJanJun - 0.1E6) / (0.15E6 - 0.1E6) * (IPFlood_input$IPFlood3[week_in_year] - IPFlood_input$IPFlood2[week_in_year])
	} else if (HenryRunoffRemainingJanJun <= 0.2E6) {
		IPFloodCurve_o <- IPFlood_input$IPFlood3[week_in_year] + (HenryRunoffRemainingJanJun - 0.15E6) / (0.2E6 - 0.15E6) * (IPFlood_input$IPFlood4[week_in_year] - IPFlood_input$IPFlood3[week_in_year])
	} else if (HenryRunoffRemainingJanJun <= 0.25E6) {
		IPFloodCurve_o <- IPFlood_input$IPFlood4[week_in_year] + (HenryRunoffRemainingJanJun - 0.2E6) / (0.25E6 - 0.2E6) * (IPFlood_input$IPFlood5[week_in_year] - IPFlood_input$IPFlood4[week_in_year])
	} else if (HenryRunoffRemainingJanJun <= 0.28E6) {
		IPFloodCurve_o <- IPFlood_input$IPFlood5[week_in_year] + (HenryRunoffRemainingJanJun - 0.25E6) / (0.28E6 - 0.25E6) * (IPFlood_input$IPFlood6[week_in_year] - IPFlood_input$IPFlood5[week_in_year])
	} else if (HenryRunoffRemainingJanJun <= 0.31E6) {
		IPFloodCurve_o <- IPFlood_input$IPFlood6[week_in_year] + (HenryRunoffRemainingJanJun - 0.28E6) / (0.31E6 - 0.28E6) * (IPFlood_input$IPFlood7[week_in_year] - IPFlood_input$IPFlood6[week_in_year])
	} else {
...
RIRFloodCurve <- function() {
	if (RirieRunoffRemainingJanJun <= 0.05E6) {
		RIRFloodCurve_o <- RIRFlood_input$RIRFlood1[week_in_year] + (RirieRunoffRemainingJanJun - 0) / (0.05E6 - 0) * (RIRFlood_input$RIRFlood2[week_in_year] - RIRFlood_input$RIRFlood1[week_in_year])
	} else if (RirieRunoffRemainingJanJun <= 0.08E6) {
		RIRFloodCurve_o <- RIRFlood_input$RIRFlood2[week_in_year] + (RirieRunoffRemainingJanJun - 0.05E6) / (0.08E6 - 0.05E6) * (RIRFlood_input$RIRFlood3[week_in_year] - RIRFlood_input$RIRFlood2[week_in_year])
	} else if (RirieRunoffRemainingJanJun <= 0.1E6) {
		RIRFloodCurve_o <- RIRFlood_input$RIRFlood3[week_in_year] + (RirieRunoffRemainingJanJun - 0.08E6) / (0.1E6 - 0.08E6) * (RIRFlood_input$RIRFlood4[week_in_year] - RIRFlood_input$RIRFlood3[week_in_year])
	} else if (RirieRunoffRemainingJanJun <= 0.15E6) {
		RIRFloodCurve_o <- RIRFlood_input$RIRFlood4[week_in_year] + (RirieRunoffRemainingJanJun - 0.1E6) / (0.15E6 - 0.1E6) * (RIRFlood_input$RIRFlood5[week_in_year] - RIRFlood_input$RIRFlood4[week_in_year])
	} else if (RirieRunoffRemainingJanJun <= 0.2E6) {
		RIRFloodCurve_o <- RIRFlood_input$RIRFlood5[week_in_year] + (RirieRunoffRemainingJanJun - 0.15E6) / (0.2E6 - 0.15E6) * (RIRFlood_input$RIRFlood6[week_in_year] - RIRFlood_input$RIRFlood5[week_in_year])
	} else if (RirieRunoffRemainingJanJun <= 0.25E6) {
		RIRFloodCurve_o <- RIRFlood_input$RIRFlood6[week_in_year] + (RirieRunoffRemainingJanJun - 0.2E6) / (0.25E6 - 0.2E6) * (RIRFlood_input$RIRFlood7[week_in_year] - RIRFlood_input$RIRFlood6[week_in_year])
	} else if (RirieRunoffRemainingJanJun <= 0.3E6) {
		RIRFloodCurve_o <- RIRFlood_input$RIRFlood7[week_in_year] + (RirieRunoffRemainingJanJun - 0.25E6) / (0.3E6 - 0.25E6) * (RIRFlood_input$RIRFlood8[week_in_year] - RIRFlood_input$RIRFlood7[week_in_year])
	} else {
...
BoiseFloodCurve <- function() {
	if (BoiseRunoffRemainingJanJul <= 0.1E6) {
		BoiseFloodCurve_o <- BoiseFlood_input$BoiseFlood1[week_in_year] + (BoiseRunoffRemainingJanJul - 0) / (0.1E6 - 0) * (BoiseFlood_input$BoiseFlood2[week_in_year] - BoiseFlood_input$BoiseFlood1[week_in_year])
	} else if (BoiseRunoffRemainingJanJul <= 0.15E6) {
		BoiseFloodCurve_o <- BoiseFlood_input$BoiseFlood2[week_in_year] + (BoiseRunoffRemainingJanJul - 0.1E6) / (0.15E6 - 0.1E6) * (BoiseFlood_input$BoiseFlood3[week_in_year] - BoiseFlood_input$BoiseFlood2[week_in_year])
	} else if (BoiseRunoffRemainingJanJul <= 0.2E6) {
		BoiseFloodCurve_o <- BoiseFlood_input$BoiseFlood3[week_in_year] + (BoiseRunoffRemainingJanJul - 0.15E6) / (0.2E6 - 0.15E6) * (BoiseFlood_input$BoiseFlood4[week_in_year] - BoiseFlood_input$BoiseFlood3[week_in_year])
	} else if (BoiseRunoffRemainingJanJul <= 0.25E6) {
		BoiseFloodCurve_o <- BoiseFlood_input$BoiseFlood4[week_in_year] + (BoiseRunoffRemainingJanJul - 0.2E6) / (0.25E6 - 0.2E6) * (BoiseFlood_input$BoiseFlood5[week_in_year] - BoiseFlood_input$BoiseFlood4[week_in_year])
	} else if (BoiseRunoffRemainingJanJul <= 0.28E6) {
		BoiseFloodCurve_o <- BoiseFlood_input$BoiseFlood5[week_in_year] + (BoiseRunoffRemainingJanJul - 0.25E6) / (0.28E6 - 0.25E6) * (BoiseFlood_input$BoiseFlood6[week_in_year] - BoiseFlood_input$BoiseFlood5[week_in_year])
	} else if (BoiseRunoffRemainingJanJul <= 0.31E6) {
		BoiseFloodCurve_o <- BoiseFlood_input$BoiseFlood6[week_in_year] + (BoiseRunoffRemainingJanJul - 0.28E6) / (0.31E6 - 0.28E6) * (BoiseFlood_input$BoiseFlood7[week_in_year] - BoiseFlood_input$BoiseFlood6[week_in_year])
	} else {
...
PayetteFloodCurve <- function() {
	if (PayetteRunoffRemainingJanJun <= 0.5E6) {
		PayetteFloodCurve_o <- PayetteFlood_input$PayetteFlood1[week_in_year] + (PayetteRunoffRemainingJanJun - 0) / (0.5E6 - 0) * (PayetteFlood_input$PayetteFlood2[week_in_year] - PayetteFlood_input$PayetteFlood1[week_in_year])
	} else if (PayetteRunoffRemainingJanJun <= 1.0E6) {
		PayetteFloodCurve_o <- PayetteFlood_input$PayetteFlood2[week_in_year] + (PayetteRunoffRemainingJanJun - 0.5E6) / (1.0E6 - 0.5E6) * (PayetteFlood_input$PayetteFlood3[week_in_year] - PayetteFlood_input$PayetteFlood2[week_in_year])
	} else if (PayetteRunoffRemainingJanJun <= 1.5E6) {
		PayetteFloodCurve_o <- PayetteFlood_input$PayetteFlood3[week_in_year] + (PayetteRunoffRemainingJanJun - 1.0E6) / (1.5E6 - 1.0E6) * (PayetteFlood_input$PayetteFlood4[week_in_year] - PayetteFlood_input$PayetteFlood3[week_in_year])
	} else if (PayetteRunoffRemainingJanJun <= 2.0E6) {
		PayetteFloodCurve_o <- PayetteFlood_input$PayetteFlood4[week_in_year] + (PayetteRunoffRemainingJanJun - 1.5E6) / (2.0E6 - 1.5E6) * (PayetteFlood_input$PayetteFlood5[week_in_year] - PayetteFlood_input$PayetteFlood4[week_in_year])
	} else if (PayetteRunoffRemainingJanJun <= 3.0E6) {
		PayetteFloodCurve_o <- PayetteFlood_input$PayetteFlood5[week_in_year] + (PayetteRunoffRemainingJanJun - 2.0E6) / (3.0E6 - 2.0E6) * (PayetteFlood_input$PayetteFlood6[week_in_year] - PayetteFlood_input$PayetteFlood5[week_in_year])
	} else {
...
OWYFloodCurve <- function() {
	if (OwyheeRunoffRemainingJanMay <= 0.5E6) {
		OWYFloodCurve_o <- OWYFlood_input$OWYFlood1[week_in_year] + (OwyheeRunoffRemainingJanMay - 0) / (0.5E6 - 0) * (OWYFlood_input$OWYFlood2[week_in_year] - OWYFlood_input$OWYFlood1[week_in_year])
	} else if (OwyheeRunoffRemainingJanMay <= 1.0E6) {
		OWYFloodCurve_o <- OWYFlood_input$OWYFlood2[week_in_year] + (OwyheeRunoffRemainingJanMay - 0.5E6) / (1.0E6 - 0.5E6) * (OWYFlood_input$OWYFlood3[week_in_year] - OWYFlood_input$OWYFlood2[week_in_year])
	} else if (OwyheeRunoffRemainingJanMay <= 2.0E6) {
		OWYFloodCurve_o <- OWYFlood_input$OWYFlood3[week_in_year] + (OwyheeRunoffRemainingJanMay - 1.0E6) / (2.0E6 - 1.0E6) * (OWYFlood_input$OWYFlood4[week_in_year] - OWYFlood_input$OWYFlood3[week_in_year])
	} else if (OwyheeRunoffRemainingJanMay <= 3.0E6) {
		OWYFloodCurve_o <- OWYFlood_input$OWYFlood4[week_in_year] + (OwyheeRunoffRemainingJanMay - 2.0E6) / (3.0E6 - 2.0E6) * (OWYFlood_input$OWYFlood5[week_in_year] - OWYFlood_input$OWYFlood4[week_in_year])
	} else {
...
BRCurFC <- function() {
	if (DARunoffAprAug <= 75E6) {
		...
		if (BRRunoffAprJul <= 3E6) {
			...
			BRFlood_o <- BRFlood_1 - (BRFlood_1 - BRFlood2) / (4E6 - 3E6) * (BRRunoffAprJul - 3E6)
		} else if (BRRunoffAprJul <= 5E6) {
			...
			BRFlood_o <- BRFlood_1 - (BRFlood_1 - BRFlood2) / (5E6 - 4E6) * (BRRunoffAprJul - 4E6)
		} else if (BRRunoffAprJul <= 6E6) {
			...
			BRFlood_o <- BRFlood_1 - (BRFlood_1 - BRFlood2) / (6E6 - 5E6) * (BRRunoffAprJul - 5E6)		
		} else {
		...
		if (BRRunoffAprJul <= 3E6) {
			...
			BRFlood_o <- BRFlood_input$BR85_6[week_in_year] - (BRFlood_input$BR85_6[week_in_year] - BRFlood_input$BR85_6[week_in_year]) / (95E6 - 85E6) * (DARunoffAprAug - 85E6)
		}
		...
		if (BRRunoffAprJul <= 3E6) {
				...
				BRFlood_o <- BRFlood_input$BR95_6[week_in_year] - (BRFlood_input$BR95_6[week_in_year] - BRFlood_input$BR95_6[week_in_year]) / (105E6 - 95E6) * (DARunoffAprAug - 95E6)
			}
		...
		if (BRRunoffAprJul <= 3E6) {
			...
			BRFlood_o <- BRFlood_input$BR105_6[week_in_year] - (BRFlood_input$BR105_6[week_in_year] - BRFlood_input$BR105_6[week_in_year]) / (115E6 - 105E6) * (DARunoffAprAug - 105E6)
		}
	} else {
		if (BRRunoffAprJul <= 3E6) {
...
BRLGAvailWater <- function() {
	...
	BRLGAvailWater_o <- max(0, Brownlee() + BRIn_c - BRDraftLimit())
...
McNaryFlowDeficit <- function() {
	if (BRPrelim_c == -9999) {
		BRPrelim_c <<- BRPrelim()
		#water_df$BRPrelim_c[week_counter] <<- BRPrelim_c
	}
